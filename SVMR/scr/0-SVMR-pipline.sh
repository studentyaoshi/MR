...
# 4. Create two files, "exposure" and "outcome", in the workplace. List the filename of exposures in the file “exposure” and the filename of the outcomes in the file “outcome”.
